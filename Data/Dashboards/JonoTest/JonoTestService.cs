...
namespace JonoTest
{
    public class JonoTestService
    {
        private List<MainCard> JonoTestCardData = new List<MainCard>()
        {
            new MainCard {
                id = 1,
                title = "Total Sales",
        ...
        private List<JonoTestTable> JonoTestOrdersData = new List<JonoTestTable>()
        {
            new JonoTestTable {
                Id=1,
                OrderId="#SPK781",
        ...
        private List<JonoTestTable> JonoTestProductsData = new List<JonoTestTable>()
        {
            new JonoTestTable {
                Id=1,
                OrderId="#1547988",
        ...
        private List<ProductList> JonoTestProductListData = new List<ProductList>()
        {
        ...
        private List<ProductActivity> JonoTestProductActivityData = new List<ProductActivity>()
        {
        ...
        private List<Payments> JonoTestProductPaymentsData = new List<Payments>()
        {
        ...
        private List<TrafficSources> JonoTestProductSourcesData = new List<TrafficSources>()
        {
        ...
        public List<MainCard> GetJonoTestMainCard() => JonoTestCardData;
        public List<JonoTestTable> GetJonoTestOrders() => JonoTestOrdersData;
        public List<JonoTestTable> GetJonoTestProducts() => JonoTestProductsData;
        public List<ProductList> GetJonoTestProductsList() => JonoTestProductListData;
        public List<ProductActivity> GetJonoTestProductsActivity() => JonoTestProductActivityData;
        public List<Payments> GetJonoTestProductsPayments() => JonoTestProductPaymentsData;
        public List<TrafficSources> GetJonoTestProductsSources() => JonoTestProductSourcesData;
