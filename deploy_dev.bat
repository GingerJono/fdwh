...
psexec \\duwpmdev01 C:\Windows\System32\inetsrv\appcmd stop apppool /apppool.name:%AppPoolName%
if %ERRORLEVEL% neq 0 (
...
psexec \\duwpmdev01 C:\Windows\System32\inetsrv\appcmd start apppool /apppool.name:%AppPoolName%
if %ERRORLEVEL% neq 0 (
